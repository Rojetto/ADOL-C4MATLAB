...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   Befehle für den endgültigen Ausdruck   %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Überschrift für Functionen im Reference-Teil;
...
% Überschrift für Blöcke im Reference-Teil;
% erzeugt Linie auf dem Seitenkopf, Eintrag in das
% Inhaltsverzeichnis und Indexregister
...
% Überschrift für Datentypen im Reference-Teil;
% erzeugt Linie auf dem Seitenkopf, Eintrag in das
% Inhaltsverzeichnis und Indexregister
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   Gliederungsbefehle für den Reference-Teil   %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Tabelle als Verzeichnis der Blöcke
...
% Tabelle für die Parameter der Simulink-Blöcke
...
%                                                          %
%   1. Falls natürliche Bildbreite größer als Textbreite,  %
...
%   Umdefinition unmöglich.                                %
%   \def\epsfsize#1#2{                                     %
%   \ifdim #1 > \textwidth \textwidth \else #1 \fi         %
%   }                                                      %
%                                                          %
%   2. Falls \epsfxsize gesetzt sicherstellen, daß         %
%   Bildbreite (\epsfxsize) <= Textbreite. Falls           %
%   \epsfxsize nicht gesetzt (=0) sicherstellen, daß       %
%   Bildbreite (#1=natürliche Bildbreite) <= Textbreite.   %
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   Befehl zum Einbinden von EPS-Bildern mit Vorgabe der Höhe   %
%   und Übergabe von Positionierungsparametern                  %
...
%   der Breite und Übergabe von Positionierungsparametern   %
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   Befehl wie EpsbildW                 %
%   zuzüglich Erzeugung eines Rahmens   %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
